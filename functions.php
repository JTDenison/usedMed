...
function usedMed_script_enqueue() {
	...
	wp_enqueue_style ( 'customstyle', get_template_directory_uri() . '/css/usedmed.css', array(), '1.0.0', 'all');
	wp_enqueue_script('customjs', get_template_directory_uri() . '/js/usedmed.js', array(), '1.0.0', true);
}
